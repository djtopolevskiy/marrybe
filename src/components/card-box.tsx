...
export function CarouselCard() {
	return (
		...
		>
			<h2 className='text-4xl text-center font-bold pt-8 bg-clip-text text-transparent bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 animate-gradient-x'>
