...
export function CategoriesBlock() {
	return (
		<section className='flex flex-col w-full max-w-4xl h-full px-2 items-center justify-center mb-4 bg-transparent relative'>
			<h2 className="text-4xl text-center font-bold py-4 bg-clip-text text-transparent bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 animate-gradient-x">Categories</h2>
